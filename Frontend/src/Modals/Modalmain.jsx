...
const Modalmain = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed top-[79px] left-[79vw] border  inset-0 bg-white rounded-sm w-[20vw] flex flex-col z-50 animate-bounceIn">
      <RxCross2
        onClick={onClose}
        className="absolute right-2 top-2 text-xl text-gray-700 cursor-pointer hover:text-black"
      ></RxCross2>
