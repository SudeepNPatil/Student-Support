...
const Modalmain = ({ isOpen, onClose, children }) => {
    ...
    return (
        <div className="fixed top-[79px] left-[79vw] border  inset-0 bg-white rounded-sm w-[20vw] flex flex-col z-50">
            ...
            <Link onClick={() => (localStorage.clear(), useNavigate('/'), window.location.reload())} className="px-6  py-2 font-semibold opacity-80 hover:bg-gray-200 rounded-xl  mt-2">Logout</Link>
