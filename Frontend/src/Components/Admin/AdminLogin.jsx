...
export default function AdminLogin() {
    ...
    const handlesubmit = async (e) => {
        ...
        const response = await fetch("https://student-support-s0xt.onrender.com/admin", {
            method: "POST",
            headers: {
    ...
    return (
        ...
        <div className="xl:w-[67%] sm:w-[58%] w-[70%] mt-20  sm:my-0  xl:px-40 lg:px-20 md:px-16 sm:px-14 mx-auto">
            ...
            <form className="flex flex-col gap-1 flex-wrap max-w-md mx-auto">
                ...
                <input onChange={handlechange} type="text" id="name" name="name" className="pl-3 rounded-md  h-10 border" />

                <label htmlFor="password" className="mt-4 font-semibold">Password</label>
                <input onChange={handlechange} type="password" id="password" name="password" className="pl-3 rounded-md  h-10 border" />

                <Link onClick={handlesubmit} type="button" className="h-10 mt-6 text-center pt-1.5 bg-blue-500 rounded-md">Login</Link>
