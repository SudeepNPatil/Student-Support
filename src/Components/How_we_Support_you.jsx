            ...
            <ScrollReveal>
                <div className="flex gap-5 mt-2  transition-all duration-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-gray-700 mt-4 mb-1">List of pre-built, well-documented academic projects. Instant order and quick delivery.</p>
                    </div>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
                <div className="flex gap-5 mt-4 transition-all duration-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-gray-700 mt-4">Students submit their idea and requirements, our team builds and delivers the project.</p>
                    </div>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
                <div className="flex gap-5 mt-4  transition-all duration-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-gray-700 mt-4">Roadmap, tech stack suggestions, deployment tips, and full mentorship for self-builders.</p>
                    </div>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
                <div className="flex gap-5 mt-4 transition-all duration-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-gray-700 mt-4">One-on-one issue resolution, bug fixing, and expert suggestions to continue the project.</p>
                    </div>
                </div>
            </ScrollReveal>
        </div>
