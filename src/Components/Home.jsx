    ...
    return (
        ...
        <div className="flex flex-col pt-20 relative mb-8 sm:mb-20">
            ...
            <div className="block relative text-center  xl:-mt-[275px] lg:-mt-[250px] md:-mt-[230px] sm:-mt-[220px] sl:-mt-[110px] xs:-mt-[90px] -mt-[75px] xl:mb-28 lg:mb-24 md:mb-24 sm:mb-24 sl:mb-3 xs:mb-4 mb-3">
                ...
                <button className="text-center sm:text-base sl:text-sm xs:text-[14px] text-[12px] sm:py-3 sl:py-2 xs:py-1 py-1 sm:px-4 sl:px-2 xs:px-1 px-1 sm:mt-5 sl:mt-3 xs:mt-2 mt-1 sl:rounded-xl xs:rounded-lg rounded-md bg-gray-800 hover:scale-110 duration-500 ease-in-out font-light text-white  hover:bg-gray-800">Order now</button>
